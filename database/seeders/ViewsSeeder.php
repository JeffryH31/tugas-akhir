...
class ViewsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        View::create(['project_id' => $this->demoProject('Inventory Module')->id, 'user_id' => $sasya->id, 'name' => 'Board', 'type' => 'board', 'is_default' => true, 'position' => 0]);
        View::create(['project_id' => $this->demoProject('Inventory Module')->id, 'user_id' => $sasya->id, 'name' => 'Gantt', 'type' => 'gantt', 'position' => 1]);
        ...
        View::create(['project_id' => $this->demoProject('Checkout & Payment')->id, 'user_id' => $budi->id, 'name' => 'Payment Board', 'type' => 'board', 'is_default' => true, 'position' => 0]);
    }
}
